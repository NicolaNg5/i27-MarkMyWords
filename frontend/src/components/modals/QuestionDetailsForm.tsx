...
const QuestionDetailsForm: React.FC<QuestionDetailsFormProps> = ({ isOpen, onClose, onSubmit, title, question = defaultQuestion}) => {
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <>
                        ...
                        <div className="mb-4">
                            ...
                            <select 
                                ...
                                required
                            >
                                <option className="text-gray-200" value="" disabled>Pick an option as the answer</option>
                ...
                {type === QuestionType.ShortAnswer && (
                    <>
                        <div className="">
                            <label className="block mb-2">Question</label>
                            <textarea value={questionText} rows={2} onChange={(e) => setQuestionText(e.target.value)} className="w-full p-2 border border-gray-300 rounded" required />
                        </div>
                        <div className="mb-4">
                            <label className="block mb-2">Suggested Answer:</label>
                            <textarea value={answer} rows={3} onChange={(e) => setAnswer(e.target.value)} className="w-full p-2 border border-gray-300 rounded" required />
                        </div>
                    </>
                )}
                ...
                {type === QuestionType.Highlighting && (
                    <>
                        <div className="">
                            <label className="block mb-2">Question</label>
                            <textarea value={questionText} rows={5} onChange={(e) => setQuestionText(e.target.value)} className="w-full p-2 border border-gray-300 rounded" required />
                        </div>
                        <div className="mb-4">
                            <label className="block mb-2">Answer</label>
                            <input
